---
title: Why I Left Managing 100+ Engineers to Build From Scratch Again
description: After 6.5 years at Nickel scaling from 3 to 40+, I chose independence, hands-on building, and the AI era.
date: 2026-04-10
---
...
## Path 1: Staying a Manager of Managers
There is a unique thrill to high-level engineering leadership. What I loved about managing managers is the incredible leverage you have. Tiny, strategic actions can yield a dramatic impact across an entire organization. Because you are detached from the daily grind of field work, you gain a holistic view that allows you to spot connections that the people actively building simply can't see. Steering the ship from that vantage point brings huge gains in generated value.

Beyond that, you learn an immense amount by managing other managers, and exposing yourself to the pressure of leading and inspiring a large department makes you progress rapidly.

But despite all of this, I realized something important: **I missed building**. 
...
For too long, data platform teams have defaulted to the "it's complicated" response, treating requests as black boxes that can take months to deliver. We are building a "yes" team — one that provides solutions today and empowers business people to answer their own needs and unlock use cases that directly generate value.
...
The workflow is a game-changer. Previously, if an analysis required data we didn't have in our data marts, you had to switch tools or submit a ticket to another team. Today, using Claude Code directly in the repo, a single conversation to analyze data can detect the interesting raw sources, load them, pipe them into marts via dbt, and execute the analysis.

*(I'll be doing a deep dive into this exact monorepo/Claude Code workflow in my next post).*
